...
const LoadingSpeed = () => {
  ...
  return (
    <section className="w-full bg-background py-[3.125rem] md:py-[6.25rem]" id='About'>
      <div className="container mx-auto">
        ...
        <h3 className="text-[1.875rem] lg:text-[5rem] mb-[2.5rem]">
          Does your website work<br />in China?
          <span className="inline-block ml-4">
            <img src={ flag } alt="China Flag" className="h-8 -mb-1 lg:h-auto lg:-mb-4" />
          </span>
        </h3>
        <m.div
          className="relative w-full max-w-[65.875rem] grid grid-cols-1 lg:grid-cols-2 gap-4 mx-auto"
          { ...motionSettings }
