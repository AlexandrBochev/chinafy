  ...
  return (
    <div className="flex flex-wrap mb-6 lg:mb-10">
      ...
      <div className="flex items-end">
        <input type={ type } name="name" placeholder={ placeholder } className="min-w-[14.2rem] border-b border-gray placeholder:text-black lg:placeholder:text-xl pb-[1px] outline-none" required />
